...
const getPrize = async () => {
	const prizes = [
		{
			image: 'https://i.postimg.cc/qvPNKRjR/dragon-L2.png',
			title: '翠璃龍'
		},
		{
			image: 'https://i.postimg.cc/xTWsXGDm/bird-L2.png',
			title: '霓羽鳥'
		},
		{
			image: 'https://i.postimg.cc/t70MGF9d/iron-L.png',
			title: '熾甲蟲'
		},
		{
			image: 'https://i.postimg.cc/mr0XHQF8/frog2.png',
			title: '潤光蛙'
		},
		{
			image: 'https://i.postimg.cc/SRtznGnz/rabbit2.png',
			title: '雪絨兔'
		},
		{
			image: 'https://i.postimg.cc/zBPqY2LH/tree2.png',
			title: '森芽獸'
		},
		{
			image: 'https://i.postimg.cc/VL4QxH3q/mouse2.png',
			title: '雷栗鼠'
		},
		{
			image: 'https://i.postimg.cc/hjM1DTg8/cat2.png',
			title: '幽燄貓'
		},
		{
			image: 'https://i.postimg.cc/9QKXDQCN/turtle2.png',
			title: '晶潮龜'
		},
		{
			image: 'https://i.postimg.cc/6q8tWkF7/fox2.png',
			title: '焰尾狐'
		},
		{
			image: 'https://i.postimg.cc/bwR3msFF/dear2.png',
			title: '星蕨鹿'
		},
		{
			image: 'https://i.postimg.cc/zvjVsYm0/stonemouse2.png',
			title: '震岩獸'
		},
		{
			image: 'https://i.postimg.cc/T1hz6nBd/worm2.png',
			title: '葉螺蟲'
		},
		{
			image: 'https://i.postimg.cc/6Qbs1H1R/angelfox2.png',
			title: '羽靈狐'
		},
		{
			image: 'https://i.postimg.cc/zDS7zL8d/dog2.png',
			title: '機芯犬'
		},
		{
			image: 'https://i.postimg.cc/wB8RRVVK/sandmouse2.png',
			title: '圓福獸'
		},
		{
			image: 'https://i.postimg.cc/pXj25tc4/bat2.png',
			title: '雷翼蝠'
		},
		{
			image: 'https://i.postimg.cc/50b5Kk3m/ghost2.png',
			title: '雲綿靈'
		},
		{
			image: 'https://i.postimg.cc/xdNrhGD2/bear2.png',
			title: '星夢熊'
		},
		{
			image: 'https://i.postimg.cc/Gtc5LGNc/mathon2.png',
			title: '軟菇獸'
		}
	]
...
const pop = () => {
  confetti($app, {
	...
	$title.children[0].innerHTML = `解鎖新夥伴！<br>${prize.title}`;
	gsap.to($title, {
		delay: 1,
		y: '5vh',
		duration: 0.6
...
const showHint2 = () => {
	$title.children[0].innerHTML = '契約成立！點我認領！';
	gsap.set($pointer, {
		x: '16vh',
		y: '3vh'
	});
